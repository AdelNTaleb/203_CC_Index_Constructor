...
def index():
    if (flask.request.args.get('strategy') is None):
        ...
        current_composition=optimal_weights(Prices_df,Method,Max_Vol,Max_Weight_Allowed,MktCap_df,Nb_Month_1,Nb_Month_2,ThreeM_USD_libor,position)
        ...
        back_tested = back_test(Prices_df,Max_Vol,Max_Weight_Allowed,MktCap_df,Method,backtest_period,Nb_Month_1,Nb_Month_2,ThreeM_USD_libor,vol_cap,freq,vol_frame,position)
